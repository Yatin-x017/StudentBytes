      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-surface border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
          >
            ...
            <div className="p-8 space-y-6 overflow-y-auto">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/2 border-white/5 focus:border-primary/50 text-lg font-bold"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-white/2 border border-white/5 rounded-xl py-3 px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all appearance-none"
                >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full h-64 bg-white/2 border border-white/5 rounded-2xl p-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all resize-none font-medium leading-relaxed"
                />
              </div>
            </div>
