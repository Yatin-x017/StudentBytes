  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-4 animate-fade-in">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-text-muted">
        ...
        <section>
          <h2 className="text-2xl font-bold text-text mb-4">1. Local-First Data</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-text mb-4">2. AI API Keys</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-text mb-4">3. Data Usage</h2>
