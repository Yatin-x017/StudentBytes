      ...
      <div className="w-full max-w-lg relative z-10">
        ...
        >
          <div className="text-center mb-12">
            <h1 className="text-4xl font-black tracking-tight text-neutral-900 mb-4">Welcome Back</h1>
            <p className="text-neutral-500 font-medium text-lg leading-relaxed">Continue your premium learning experience.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate('/dashboard')}
              className="w-full flex items-center justify-center gap-4 bg-slate-900 border border-neutral-800 py-5 rounded-[2rem] font-bold text-white hover:bg-slate-800 transition-premium shadow-xl shadow-slate-900/10"
            >
          ...
          <div className="relative my-12">
            ...
            <div className="relative flex justify-center text-[11px] font-black uppercase tracking-[0.2em] text-neutral-400">
              <span className="bg-white/10 px-6 backdrop-blur-md">Or with email</span>
            </div>
          </div>

          <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }}>
            <div className="space-y-3">
                <label className="text-[11px] font-black uppercase tracking-[0.2em] text-neutral-400 ml-6">Email Address</label>
                <input
                    type="email"
             ...
             <div className="space-y-3">
                <div className="flex justify-between items-center px-6">
                    <label className="text-[11px] font-black uppercase tracking-[0.2em] text-neutral-400">Password</label>
          ...
          <p className="mt-12 text-center font-bold text-slate-500">
            Don't have an account? <button onClick={() => navigate('/signup')} className="text-primary font-black hover:underline uppercase tracking-widest text-xs ml-2">Sign Up</button>
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-16 flex justify-center gap-12 text-[11px] font-black text-neutral-400 uppercase tracking-[0.2em]"
        >
